...
export default function Footer() {
  return (
    <div className="  flex flex-col items-center  h-[464px] border-[1px] border-[#E3E8EC] max-sm:items-center lg:bg-[#EEF2F2] max-sm:bg-[#EEF2F2]  md:bg-white  border-t-1 flex-wrap">
      <div className="lg:w-[1157px] max-sm:w-[311px] md:w-[620px] h-[464px] flex flex-col justify-center gap-5">
        <div className=" border-gray-300   flex 7 max-sm:flex-wrap max-sm:justify-between lg:justify-between max-sm:gap-10 md:justify-between lg:gap-0">
