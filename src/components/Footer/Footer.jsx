...
export default function Footer() {
  return (
    <div className="  flex flex-col items-center  py-5 border-[1px] border-[#E3E8EC] max-sm:items-center lg:bg-[#EEF2F2] max-sm:bg-[#EEF2F2]  md:bg-white  pt-16 border-t-1 flex-wrap">
      <div className="lg:w-[1157px] max-sm:w-[311px] md:w-[620px] h-[464px]">
